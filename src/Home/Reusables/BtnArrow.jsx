...
export default function BtnArrow({className, content}) {
  return (
    <button className={`btn-arrow flex justify-center items-center mt-[8px] w-full h-[44px] rounded-[18px] bg-[#5642f3] text-white text-[18px] hover:h-[52px] hover:w-[98%] duration-300 ease-in-out origin-center ${className}`}>
        {content}
